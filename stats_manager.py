...
from records_manager import get_unique_image_count, get_total_conversion_count
...
def get_stats() -> dict:
    with _lock:
        stats = _load_stats()
    stats["total_unique_images"] = get_unique_image_count()
    stats["total_conversions"] = get_total_conversion_count()
    return stats
